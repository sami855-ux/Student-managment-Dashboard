  ...
  return (
    <div className={styles.wrapper}>
      ...
      <ul className={styles.menu}>
        ...
        <section className={styles.helpWrap}>
          ...
          <h2>Help Center</h2>
          <p>
            Having trouble in admin store <br /> please contact us for more
            qusetions
          </p>
...
function LinkMenu({ title, icon, to }) {
  return (
    <NavLink to={`${to}`}>
      <li className={styles.active}>
        <div className={styles.indictor}></div>
        {icon}
        <p>{title}</p>
      </li>
    </NavLink>
